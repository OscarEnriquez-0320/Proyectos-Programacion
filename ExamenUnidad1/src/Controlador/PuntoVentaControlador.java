...
public class PuntoVentaControlador implements ActionListener {
    ...
    public PuntoVentaControlador(VistaPuntoVenta vista, GestionInventario modeloInventario, 
        ...
        ArrayList<Venta> ventasCargadas = ArchivoVentas.importarCSV();
        for (Venta v : ventasCargadas) {
            this.modeloVentas.agregarVenta(v);
        }
        
        int ultimo = ArchivoVentas.obtenerUltimoCorrelativo();
        this.modeloVentas.setCorrelativoDesdeArchivo(ultimo);
        
        this.carritoActual = new ArrayList<>();
        this.fechaActual = new SimpleDateFormat("dd-MM-yyyy").format(new Date());
        this.ticketActual = modeloVentas.generarNuevoTicket();
    ...
    private void procesarPago() {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            ...
            ArchivoVentas.exportarCSV(carritoActual);
            
            mostrarTicket();
            
            ticketActual = modeloVentas.generarNuevoTicket();
            carritoActual.clear();
            actualizarTablaCarrito();
